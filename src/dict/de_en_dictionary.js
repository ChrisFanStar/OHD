...
class de_en_dictionary {
  ...
  async findTerm(word) {
    ...
    let base = 'https://zh.pons.com/%E7%BF%BB%E8%AF%91-2/%E5%BE%B7%E8%AF%AD-%E8%8B%B1%E8%AF%AD/';
    ...
    scriptTags.forEach((script) => {
      ...
      if (content.includes('window.backendResponses')) {
        // 提取JSON数据
        console.log(content);
        console.log(4444);
        // 使用正则表达式提取 translation 内容
        ...
        if (match) {
          ...
          console.log('Pure text translation:', textContent.trim());
        } else {
  ...
  async findCollins(word) {
    ...
    function getCollins(doc) {
      ...
      let defNodes = doc.querySelectorAll('div[data-e2e="arab"]');
